...
// =========================================
// TASK 8 - BACKGROUND JOB QUEUE
// =========================================

const taskQueue = new Queue("taskflow-jobs", {
    connection: {
        host: "127.0.0.1",
        port: 6379,
...
// =========================================
// TASK 8 - REDIS CACHED QUOTE API
// =========================================

app.get("/api/quote", authMiddleware, quoteLimiter, async(req, res) => {
    const cacheKey = "taskflow:daily-quote";
    ...
    try {
        ...
        if (cachedQuote) {
            console.log("Quote served from Redis cache.");
        ...
        console.log("Cache miss. Fetching quote from external API.");
        ...
        // Store quote in Redis for 60 seconds
        await redis.set(
            cacheKey,
        ...
        console.log("Quote stored in Redis cache.");
